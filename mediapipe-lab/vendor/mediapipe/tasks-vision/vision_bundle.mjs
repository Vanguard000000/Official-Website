...
function N(t) {
  O(I);
  var e = t.g;
  return null == (e = null == e || M(e) ? e : "string" == typeof e ? F(e) : null) ? e : (t.g = e);
}
var U = class {
  constructor(t, e) {
...
var wt = Et((t) => "number" == typeof t),
  ...
  kt = Et((t) => (At ? t >= xt && t <= Rt : "-" === t[0] ? Ft(t, St) : Ft(t, Lt)));
...
function Gt(t, e) {
  if (((t >>>= 0), (e >>>= 0) <= 2097151)) var n = "" + (4294967296 * e + t);
    ...
    V()
      ...
      : ((t = (16777215 & t) + 6777216 * (n = 16777215 & ((t >>> 24) | (e << 8))) + 6710656 * (e = (e >> 16) & 65535)),
        (n += 8147497 * e),
        (e *= 2),
...
function Vt(t) {
  if (t.length < 16) Nt(Number(t));
    ...
    for (let r = e, i = ((n - e) % 6) + e; i <= n; r = i, i += 6) {
      ...
      ((Ot *= 1e6),
        (Pt = 1e6 * Pt + e),
        Pt >= 4294967296 && ((Ot += Math.trunc(Pt / 4294967296)), (Ot >>>= 0), (Pt >>>= 0)));
    }
    if (e) {
      const [t, e] = Xt(Pt, Ot);
      ((Pt = t), (Ot = e));
...
function Zt(t) {
  ...
  if (
    ...
    !("-" === t[0]
      ? t.length < 20 || (20 === t.length && Number(t.substring(0, 7)) > -922337)
...
function Qt(t) {
  return null == t
    ? t
    : "bigint" == typeof t
      ? (kt(t) ? (t = Number(t)) : ((t = BigInt.asIntN(64, t)), (t = kt(t) ? Number(t) : String(t))), t)
      : Kt(t)
        ? "number" == typeof t
          ? Jt(t)
          : Zt(t)
    ...
    if ("string" === e)
      return (
        ...
        Number.isSafeInteger(e) && e >= 0
          ? (t = String(e))
          : (-1 !== (e = t.indexOf(".")) && (t = t.substring(0, e)), qt(t) || (Vt(t), (t = Gt(Pt, Ot)))),
        t
      );
    if ("number" === e)
...
function ie(t, e, n, r) {
  ...
  if (!Array.isArray(t))
    return (
      n ? (2 & r ? ((t = e[K]) ? (e = t) : (nt((t = new e()).u), (e = e[K] = t))) : (e = new e())) : (e = void 0),
      e
    );
  let i = (n = Q(t));
  return (0 === i && (i |= 32 & r), (i |= 2 & r), i !== n && et(t, i), new e(t));
}
function se(t, e, n) {
  if (e)
    t: {
      ...
      switch (typeof e) {
        ...
        case "bigint":
          ...
          e = At ? BigInt(e) : bt(e) ? (e ? "1" : "0") : Tt(e) ? e.trim() || "0" : String(e);
          break t;
        default:
          e = Jt(e);
      }
...
function oe(t) {
  if ((void 0 === he && (he = "function" == typeof Proxy ? ye(Proxy) : null), !he || !me())) return t;
  let e = ae?.get(t);
  return (
    e ||
    (Math.random() > 0.01
...
function _e(t, e, n) {
  if (me()) {
    ...
    Ee(t, n) ? ((i = (r = fe ||= new ue()).get(e)) || ((i = new ue()), r.set(e, i)), i.set(t, n)) : (G(), Te(t, e));
  }
}
function ve(t, e) {
...
function Ee(t, e) {
  ...
  for (const i in e) {
    var n,
      r = Number(i);
    if (
      ((n = Number.isInteger(r)) && ((n = t[r]), (r = e[r]), (n = !(Number.isNaN(n) ? Number.isNaN(r) : n === r))), n)
    )
      return !1;
  }
  return !0;
...
function Ae(t, e, n, r) {
  if (((r = r ?? 0), null == t && (t = de), (de = void 0), null == t)) {
    var i = 96;
    (n ? ((t = [n]), (i |= 512)) : (t = []), e && (i = (-33521665 & i) | ((1023 & e) << 15)));
  } else {
...
const Le = Se
  ? (Object.setPrototypeOf(xe.prototype, Map.prototype),
    Object.defineProperties(xe.prototype, { size: { value: 0, configurable: !0, enumerable: !0, writable: !0 } }),
    xe)
  : class extends Map {
      constructor() {
        super();
...
var Me = class extends Le {
  constructor(t, e, n = Re, r = Re) {
    super();
    let i = Q(t);
    ((i |= 64), et(t, i), (this.M = i), (this.T = e), (this.S = n), (this.Z = this.T ? Ie : r));
  ...
  Oa(t) {
    ...
    ((t = t[1]), (t = this.T ? (void 0 === t ? null : t) : this.Z(t, !1, !0, void 0, !1, this.M)), super.set(e, t));
  }
  has(t) {
  ...
  get(t) {
    ...
    if (void 0 !== e) {
      var n = this.T;
      return n ? ((n = this.Z(e, !1, !0, n, this.ta, this.M)) !== e && super.set(t, n), n) : e;
    }
  }
  oa() {
...
function Ue(t, e, n, r, i) {
  if (null != t) {
    if (Array.isArray(t)) t = lt(t) ? void 0 : i && 2 & Q(t) ? t : De(t, e, n, void 0 !== r, i);
    else if (ht(t)) {
      const s = {};
            ...
            case "object":
              if (t)
                if (Array.isArray(t)) {
                  ...
                  if (t instanceof U) {
                    const e = t.g;
                    return null == e ? "" : "string" == typeof e ? e : (t.g = S(e));
                  }
    ...
    if (Array.isArray(t)) {
      ...
      return 2 & r
        ...
        : ((e &&= 0 === r || (!!(32 & r) && !(64 & r || !(16 & r)))),
          e ? (et(t, -12293 & (34 | r)), t) : De(t, je, 4 & r ? it : n, !0, !0));
    }
    return (
      t.X === ot
        ? ((n = t.u), (t = 2 & (r = tt(n)) ? t : Ve(t, n, r, !0)))
        : t instanceof Me && !(2 & t.M) && ((n = nt(t.Y(je))), (t = new Me(n, t.T, t.S, t.Z))),
      t
    );
  }
}
...
function We(t, e, n, r) {
  return (
    !(4 & e) ||
    (null != n &&
      (!r && 0 === n && (4096 & e || 8192 & e) && (t.constructor[q] = 1 + (0 | t.constructor[q])) < 5 && G(),
      0 !== n && !(n & e)))
  );
}
function ze(t, e) {
...
function Ye(t, e, n, r) {
  ...
  if (!(n >= i)) {
    ...
    return r && 256 & e && null != (r = t[s - 1][n])
      ? (Ke(t, e, i, n) && null != Y && ((e = (t = B ??= {})[Y] || 0) >= 4 || ((t[Y] = e + 1), G())), r)
      : Ke(t, e, i, n);
  }
...
function qe(t, e, n, r) {
  ...
  if (n >= i) {
    ...
    return ((s[n] = r), n < i && (t[n + (+!!(512 & e) - 1)] = void 0), o !== e && et(t, o), o);
  }
...
function Je(t, e, n, r, i) {
  ...
  let c = Q(i);
  return (
    0 !== c || !a || s || o ? 1 & c || ((c |= 1), et(i, c)) : ((c |= 33), et(i, c)),
    s
      ? ((t = !1), 2 & c || (nt(i), (t = !!(4 & c))), (r || t) && Object.freeze(i))
      : ((s = !!(2 & c) || !!(2048 & c)),
        r && s ? ((i = X(i)), (s = 1), a && !o && (s |= 32), et(i, s), qe(t, e, n, i)) : o && 32 & c && !s && Z(i, 32)),
    i
  );
}
function Ze(t, e) {
...
function en(t, e, n, r, i, s) {
  ...
  if ((ve(h, t), (2 !== r && 1 !== r) || Te(h, t), We(t, c, void 0, s))) {
    ...
    (t < h && (i.length = t), (c = -4097 & (20 | (c = rn(c, a)))), et(i, (c &= -8193)), 2 & c && Object.freeze(i));
  }
  let u;
  return (
    1 === r || (4 === r && 32 & c)
      ...
      : ((n = 5 === r && (!!(32 & c) || sn(c) || !!ae?.get(i))),
        (2 === r || n) && sn(c) && ((i = X(i)), (c = En((c = vn(c, a)), a, s)), et(i, c), (a = qe(o, a, e, i))),
...
function fn(t, e, n, r) {
  let i,
    s = tt(t);
  if (null != (r = Ye(t, s, n, r)) && r.X === ot) return ((e = He(r)) !== r && qe(t, s, n, e), e.u);
  if (Array.isArray(r)) {
    const t = Q(r);
...
function gn(t, e, n, r, i, s, o) {
  ...
  if (o && !(8 & h || (!c.length && (1 === i || (4 === i && 32 & h))))) {
    for (sn(h) ? ((c = X(c)), (h = vn(h, e)), (e = qe(a, e, r, c))) : Te(c, t), n = c, o = h, l = 0; l < n.length; l++)
      (h = n[l]) !== (f = He(h)) && (n[l] = f);
  ...
  return (
    1 === i || (4 === i && 32 & h)
      ? sn(h) ||
        ((t = h), (h |= !c.length || (16 & h && (!u || 32 & h)) ? 2 : 2048) !== t && et(c, h), Object.freeze(c))
      : ((u = 5 === i && (!!(32 & h) || sn(h) || !!ae?.get(c))),
        (2 === i || u) && sn(h) && ((c = X(c)), (h = En((h = vn(h, e)), e, s)), et(c, h), (e = qe(a, e, r, c))),
...
function wn(t, e, n, r) {
  const i = tt(t.u);
  (dt(i), (t = gn(t, i, n, e, 2, !0)), (r = null != r ? r : new n()), t.push(r), 2 & Q(r.u) ? Z(t, 8) : Z(t, 16));
}
function Tn(t, e) {
  return t ?? e;
}
...
function Rn(t, e, n) {
  {
    ...
    if ((dt(c), null == n)) qe(a, c, e);
      ...
      if (((r = !o) && ((r = void 0 === vt) || (r = !!f && void 0 !== _t)), We(t, i))) {
        ((i = 21), o && ((n = X(n)), (s = 0), (i = En((i = vn(i, c)), c, !0))));
        for (let t = 0; t < n.length; t++) n[t] = ee(n[t]);
      }
      (r ? ((n = X(n)), (s = 0), (i = En((i = vn(i, c)), c, !0))) : o || _e(n, t), i !== s && et(n, i), qe(a, c, e, n));
    }
  }
}
function Fn(t, e, n) {
...
function On(t) {
  ...
  if (t.constructor === U) return { buffer: N(t) || new Uint8Array(0), O: !0 };
...
function Vn(t, e, { ca: n = !1 } = {}) {
  ((t.ca = n), e && ((e = On(e)), (t.h = e.buffer), (t.m = e.O), (t.j = 0), (t.l = t.h.length), (t.g = t.j)));
}
function Xn(t, e) {
...
function Wn(t, e) {
  ...
  return (
    t.ca && t.m
      ...
      : ((t = t.h),
        (n = n === (e = n + e) ? new Uint8Array(0) : Mt ? t.slice(n, e) : new Uint8Array(t.subarray(n, e)))),
...
function $n(t, e, n) {
  const r = t.g.l,
    ...
    s = t.g.g + i;
  let o = s - r;
  if ((o <= 0 && ((t.g.l = s), n(e, t, void 0, void 0, void 0), (o = s - t.g.g)), o))
    throw Error(
    ...
    for (; u < e;) {
      ...
      (l < 128
        ...
        : l < 224
          ? u >= e
            ? n()
            : ((i = t[u++]), l < 194 || 128 != (192 & i) ? (u--, n()) : a.push(((31 & l) << 6) | (63 & i)))
          : l < 240
            ? u >= e - 1
              ? n()
              : ((i = t[u++]),
                128 != (192 & i) || (224 === l && i < 160) || (237 === l && i >= 160) || 128 != (192 & (c = t[u++]))
                  ? (u--, n())
...
function rr(t) {
  (we(t), (t = tr ? t.u : De(t.u, Ge, void 0, void 0, !1)));
  {
    ...
    if (h) {
          ...
          if (o)
            for (let t in o)
              isNaN(+t)
                ? ((s ??= {})[t] = o[t])
                : ((r = o[t]),
                  Array.isArray(r) && (lt(r) || (ct(r) && 0 === r.size)) && (r = null),
                  null == r && (a = !0),
                  null != r && ((s ??= {})[t] = r));
          if ((a || (s = o), s))
            for (let t in s) {
      ...
      for (; h > 0 && (null == (s = i[h - 1]) || lt(s) || (ct(s) && 0 === s.size)); h--) var c = !0;
      ((i !== t || o || c) &&
        (e ? (c || o || a) && (i.length = h) : (i = Array.prototype.slice.call(i, 0, h)), a && i.push(a)),
        (c = i));
    } else c = t;
  }
  return c;
...
let or;
function ar(t) {
  return t ? (/^-?\d+$/.test(t) ? (Vt(t), new cr(Pt, Ot)) : null) : (hr ||= new cr(0, 0));
}
var cr = class {
  constructor(t, e) {
    ((this.h = t >>> 0), (this.g = e >>> 0));
...
var wr = Er(),
  ...
  Rr = class {
    constructor(t, e, n) {
      ((this.g = t), (this.h = e), (t = wr), (this.l = (!!t && n === t) || !1));
    }
  };
function Fr(t, e) {
...
function Gr(t, e, n, r) {
  ...
  (i = {}).W = (function (t) {
    switch (typeof t) {
      ...
      case "number":
        return t > 0 ? void 0 : 0 === t ? (ge ||= [0, void 0]) : [-t, void 0];
      case "string":
        return [0, t];
      case "object":
        return t;
  ...
  s &&
    ...
    ((i.ia = s), "function" == typeof (s = r[++o]) && ((i.na = !0), (Dr ??= s), (Br ??= r[o + 1]), (s = r[(o += 2)])));
  const a = {};
...
function Vr(t, e) {
  return t instanceof nr ? (we(t), t.u) : Array.isArray(t) ? be(t, e, !1) : void 0;
}
function Xr(t, e, n, r) {
  const i = n.g;
...
function Hr(t, e, n, r, i) {
  const s = n.g;
  let o, a;
  t[e] = (t, e, n) => s(t, e, n, (a ||= Gr(Cr, Xr, Hr, r).W), (o ||= Wr(r)), i);
}
function Wr(t) {
  let e = t[Nr];
  if (null != e) return e;
    ...
    (e = n.na
      ...
      : (t, e) => {
          ...
          for (; Kn(e) && 4 != e.h;) {
            ...
            if (null == s) {
              var o = n.ia;
              o && (o = o[i]) && null != (o = zr(o)) && (s = n[i] = o);
            }
            (null != s && s(e, t, i)) ||
              ((i = (s = e).l),
              Yn(s),
              s.ha ? (s = void 0) : ((o = s.g.g - i), (s.g.g = i), (s = Wn(s.g, o))),
              (i = t),
              s && ((gt ||= Symbol()), (o = i[gt]) ? o.push(s) : (i[gt] = [s])));
          }
...
function qr(t, e, n) {
  for (var r = Q(t), i = +!!(512 & r) - 1, s = t.length, o = 512 & r ? 1 : 0, a = s + (256 & r ? -1 : 0); o < a; o++) {
    const r = t[o];
    if (null == r) continue;
    const s = o - i,
      a = Jr(n, s);
  ...
  if (256 & r) {
    r = t[s - 1];
    for (const t in r) ((i = +t), Number.isNaN(i) || (null != (s = r[i]) && (a = Jr(n, i)) && a(e, s, i)));
  }
  if ((t = gt ? t[gt] : void 0)) for (pr(e, e.g.end()), n = 0; n < t.length; n++) pr(e, N(t[n]) || new Uint8Array(0));
}
function Jr(t, e) {
  var n = t[e];
  if (n) return n;
...
function Zr(t, e) {
  if (Array.isArray(e)) {
    ...
    return (i < r && (e.length = i), et(e, -12289 & (5 | n)), 2 & n && Object.freeze(e), e);
  }
}
function Qr(t, e, n) {
  return new Rr(t, e, n);
      ...
      switch ((gr(t, n, 0), typeof e)) {
        ...
        case "bigint":
          ((n = BigInt.asUintN(64, e)),
            (n = new cr(Number(n & BigInt(4294967295)), Number(n >> BigInt(32)))),
            ur(t.g, n.h, n.g));
          break;
        default:
...
function ci(t, e, n) {
  null != (e = null == e || "string" == typeof e || M(e) || e instanceof U ? e : void 0) && _r(t, n, On(e).buffer);
}
function hi(t, e, n) {
  return (5 === t.h || 2 === t.h) && ((e = Je(e, tt(e), n, 2, !1)), 2 == t.h ? Zn(t, Gn, e) : e.push(Gn(t.g)), !0);
}
var ui = Qr(
    function (t, e, n) {
      if (1 !== t.h) return !1;
    ...
    function (t, e, n) {
      null != (e = Ht(e)) &&
        (gr(t, n, 1),
        (t = t.g),
        (n = It ||= new DataView(new ArrayBuffer(8))).setFloat64(0, +e, !0),
        (Pt = n.getUint32(0, !0)),
        (Ot = n.getUint32(4, !0)),
        dr(t, Pt),
        dr(t, Ot));
  ...
  gi = Qr(
    function (t, e, n) {
      return 0 === t.h && (ei(e, n, 0 === (t = Cn(t.g, Bt)) ? void 0 : t), !0);
    },
    ri,
    kr,
  ),
      ...
      if (null != (e = te(e))) {
        ...
        if (null != e)
          switch ((gr(t, n, 0), typeof e)) {
            ...
            case "bigint":
              ((n = BigInt.asUintN(64, e)),
                (n = new sr(Number(n & BigInt(4294967295)), Number(n >> BigInt(32)))),
                ur(t.g, n.h, n.g));
              break;
            default:
  ...
  _i = ti(
    function (t, e, n) {
      return (0 === t.h || 2 === t.h) && ((e = Je(e, tt(e), n, 2, !1)), 2 == t.h ? Zn(t, Un, e) : e.push(Un(t.g)), !0);
    },
    function (t, e, n) {
  ...
  vi = Qr(
    function (t, e, n) {
      return 0 === t.h && (ei(e, n, 0 === (t = Un(t.g)) ? void 0 : t), !0);
    },
    ii,
    Ar,
  ),
  ...
  wi = Qr(
    function (t, e, n) {
      return 0 === t.h && (ei(e, n, !1 === (t = Nn(t.g)) ? void 0 : t), !0);
    },
    si,
    Tr,
  ),
  ...
  ki = (function (t, e, n = wr) {
    ...
    function (t, e, n, r, i) {
      ...
      return (
        (s = tt(e)),
        4 & Q(o) && ((o = X(o)), et(o, -2079 & (1 | Q(o))), qe(e, s, n, o)),
        o.push(r),
        $n(t, r, i),
        !0
      );
    ...
    function (t, e, n, r, i) {
      if (Array.isArray(e)) for (let s = 0; s < e.length; s++) ai(t, e[s], n, r, i);
    },
  ),
  Si = Fr(function (t, e, n, r, i, s) {
    return 2 === t.h && (un(e, Q(e), s, n), $n(t, (e = fn(e, r, n)), i), !0);
  }, ai),
  xi = Qr(
    function (t, e, n) {
  ...
  Li = ti(
    function (t, e, n) {
      return (0 === t.h || 2 === t.h) && ((e = Je(e, tt(e), n, 2, !1)), 2 == t.h ? Zn(t, Dn, e) : e.push(Dn(t.g)), !0);
    },
    function (t, e, n) {
      if (null != (e = Zr($t, e)))
        for (let o = 0; o < e.length; o++) {
...
var Oi = class extends nr {
  ...
  Ci = [
    ...
    Qr(
      function (t, e, n) {
        return 2 === t.h && (ei(e, n, (t = Jn(t)) === C() ? void 0 : t), !0);
      },
      function (t, e, n) {
        if (null != e) {
          if (e instanceof nr) {
...
function Di(t) {
  void 0 === Ni &&
    (Ni = (function () {
      ...
      try {
        const e = (t) => t;
        t = Ui.createPolicy("goog#html", { createHTML: e, createScript: e, createScriptURL: e });
      } catch (t) {}
      return t;
    })());
  var e = Ni;
...
var Gi = [0, yi, Ri, Ei, -1, _i, Ri, -1],
  ...
  Vi = [
    ...
    ti(
      function (t, e, n) {
        return (
          (0 === t.h || 2 === t.h) && ((e = Je(e, tt(e), n, 2, !1)), 2 == t.h ? Zn(t, jn, e) : e.push(Un(t.g)), !0)
        );
      },
      function (t, e, n) {
        if (null != (e = Zr(Yt, e)) && e.length) {
...
Yi[336783863] = [
  ...
  -1,
  yi,
  [0, [1, 2, 3, 4, 5, 6, 7], Si, Wi, Si, Vi, Si, Xi, Si, zi, Si, Gi, Si, [0, Ai, -2], Si, [0, Ai, Ri]],
  [0, Ai],
  Ei,
...
var os = class extends nr {
  ...
  as = [
    -500,
    ki,
    [-500, bi, -1, Ti, -3, [-2, Yi, Ei], ki, Ci, vi, -1, es, ns, ki, [0, bi, wi], bi, $i, vi, Ti, 987, Ti],
    4,
    ki,
    [-500, Ai, -1, [-1, {}], 998, Ai],
    ki,
...
var cs = Ii(os, as),
  ...
  ms = Ii(
    ...
    [
      ...
      _i,
      di,
      [0, Ri, [0, yi, -3], [0, li, -3], [0, yi, -1, [0, ki, [0, yi, -2]]], ki, [0, li, -1, Ai, li]],
      Ai,
      -1,
      pi,
      ki,
      ...
      g() {
        ...
        return (
          (t = (function (t, e, n) {
            ...
            return (s || (64 & Q(n) ? Z(n, 32) : 32 & e && J(n, 32)), qe(t, e, 2, (r = new Me(n, r, se, void 0))), r);
          })(t, e, Ye(t, e, 2))),
          !n && bo && (t.ta = !0),
          t
        );
...
function Io(t, e) {
  return (
    (e = e ? e.clone() : new Ms()),
    void 0 !== t.displayNamesLocale ? $e(e, 1, ne(t.displayNamesLocale)) : void 0 === t.displayNamesLocale && $e(e, 1),
    void 0 !== t.maxResults ? xn(e, 2, t.maxResults) : "maxResults" in t && $e(e, 2),
    void 0 !== t.scoreThreshold ? Ln(e, 3, t.scoreThreshold) : "scoreThreshold" in t && $e(e, 3),
    void 0 !== t.categoryAllowlist ? Rn(e, 4, t.categoryAllowlist) : "categoryAllowlist" in t && $e(e, 4),
    void 0 !== t.categoryDenylist ? Rn(e, 5, t.categoryDenylist) : "categoryDenylist" in t && $e(e, 5),
    e
  );
}
function Po(t, e = -1, n = "") {
...
function Oo(t) {
  ...
  for (let t = 0; t < e.length; t++)
    s.categories.push({ score: e[t], index: n[t] ?? -1, categoryName: r[t] ?? "", displayName: i[t] ?? "" });
  if (
    ((e = pn(t, gs, 4)?.h()) &&
      (s.boundingBox = {
        originX: bn(e, 1) ?? 0,
    ...
    for (const e of pn(t, gs, 4).g())
      s.keypoints.push({ x: Ze(e, 1) ?? 0, y: Ze(e, 2) ?? 0, score: Ze(e, 4) ?? 0, label: re(ze(e, 3)) ?? "" });
  return s;
}
function Co(t) {
  const e = [];
  for (const n of mn(t, vs, 1))
    e.push({ x: An(n, 1) ?? 0, y: An(n, 2) ?? 0, z: An(n, 3) ?? 0, visibility: An(n, 4) ?? 0 });
  return e;
}
function No(t) {
  const e = [];
...
function Ho() {
  ...
  return (
    ...
    (!(function (t = navigator) {
      ...
      !!((t = t.userAgent.match(/Version\/([\d]+).*Safari/)) && t.length >= 1 && Number(t[1]) >= 17))
  );
}
async function Wo(t) {
...
function Yo(t, e, n) {
  ...
  const [r, i] = zo(e);
  return (
    !t.l || (r === t.i.canvas.width && i === t.i.canvas.height) || ((t.i.canvas.width = r), (t.i.canvas.height = i)),
    [r, i]
  );
}
function $o(t, e, n) {
...
function Qo(t, e) {
  ...
  ("string" == typeof e ? ($e(n, 2, ne(e)), $e(n, 1)) : e instanceof Uint8Array && ($e(n, 1, ut(e, !1, !1)), $e(n, 2)),
...
((sa.prototype.close = sa.prototype.close),
  (function (e, n) {
    ...
    for (; e.length && (r = e.shift());)
      e.length || void 0 === n ? (i = i[r] && i[r] !== Object.prototype[r] ? i[r] : (i[r] = {})) : (i[r] = n);
  })("TaskRunner", sa));
class aa {
  constructor(t, e, n, r) {
...
function la(t, e, n, r) {
  return (
    ua(t, e),
    t.h || (t.m(), t.C()),
    n ? (t.s || (t.s = ha(t, !0)), (n = t.s)) : (t.v || (t.v = ha(t, !1)), (n = t.v)),
    e.useProgram(t.h),
    n.bind(),
    t.l(),
    (t = r()),
...
function da(t, e, n) {
  (ua(t, e),
    t.A || (t.A = oa(e.createFramebuffer(), "Failed to create framebuffe.")),
...
var ma = class extends ga {
    ...
    m() {
      super.m();
      const t = this.g;
      ((this.L = oa(t.getUniformLocation(this.h, "backgroundTexture"), "Uniform location")),
        (this.U = oa(t.getUniformLocation(this.h, "colorMappingTexture"), "Uniform location")),
        (this.K = oa(t.getUniformLocation(this.h, "maskTexture"), "Uniform location")));
    }
    l() {
      super.l();
      const t = this.g;
  ...
  ya = class extends ga {
    ...
    C() {
      const t = this.g;
      (t.activeTexture(t.TEXTURE1), (this.j = fa(this, t)), t.activeTexture(t.TEXTURE2), (this.B = fa(this, t)));
    }
    m() {
      super.m();
      const t = this.g;
      ((this.K = oa(t.getUniformLocation(this.h, "defaultTexture"), "Uniform location")),
        (this.L = oa(t.getUniformLocation(this.h, "overlayTexture"), "Uniform location")),
...
function Aa(t) {
  ...
  let n = _a(t, 2);
  return (
    n || ((n = fa(ba(t), e, t.m ? e.LINEAR : e.NEAREST)), t.g.push(n), (t.j = !0)),
  ...
  xa = class {
    constructor(t, e, n, r, i, s, o) {
      ((this.g = t),
        ...
        this.j &&
          0 === --La &&
          console.error("You seem to be creating MPMask instances without invoking .close(). This leaks resources."));
    }
    Ha() {
      return !!_a(this, 0);
    }
    ...
    clone() {
      ...
      return new xa(t, this.m, this.R(), this.canvas, this.l, this.width, this.height);
    }
    close() {
...
function Ca(t, e, n) {
  if (e.R()) n(e.N());
    ...
    t.m = t.m ?? new ga();
    const i = Oa(t);
    (n((t = new xa([r], e.m, !1, i.canvas, t.m, e.width, e.height)).N()), t.close());
  }
}
function Na(t, e, n, r) {
  const i = (function (t) {
    ...
    (!(function (t, e, n, r) {
      ...
      if (
        ...
        (r.forEach((t, n) => {
          ...
          i.texImage2D(i.TEXTURE_2D, 0, i.RGBA, 256, 1, 0, i.RGBA, i.UNSIGNED_BYTE, new Uint8Array(e)));
      }
    })(i, e, o, r),
    ...
    if (t) {
      ...
      for (const s of t)
        ((n.fillStyle = Ma(e.fillColor, { index: i, from: s })),
          ...
          (t = new Path2D()).arc(s.x * r.width, s.y * r.height, Ma(e.radius, { index: i, from: s }), 0, 2 * Math.PI),
          n.fill(t),
          n.stroke(t),
          ++i);
      n.restore();
  ...
  xa(t, e, n = [0, 0, 0, 255]) {
    this.l
      ? (function (t, e, n, r) {
          const i = Oa(t);
          Ca(t, e, (e) => {
            (Na(t, e, n, r), (e = Pa(t)).drawImage(i.canvas, 0, 0, e.canvas.width, e.canvas.height));
          });
        })(this, t, n, e)
      : Na(this, t.N(), n, e);
  }
  ya(t, e, n) {
    this.l
      ? (function (t, e, n, r) {
          const i = Oa(t);
          Ca(t, e, (e) => {
            (Ua(t, e, n, r), (e = Pa(t)).drawImage(i.canvas, 0, 0, e.canvas.width, e.canvas.height));
          });
        })(this, t, e, n)
      : Ua(this, t.N(), e, n);
  }
...
function Ha(t) {
  ...
  (e.viewport(0, 0, t.width, t.height), e.activeTexture(e.TEXTURE0));
  let n = Ba(t, 2);
  return (n || ((n = fa(Xa(t), e)), t.g.push(n), (t.m = !0)), e.bindTexture(e.TEXTURE_2D, n), n);
}
function Wa(t) {
  t.h.bindTexture(t.h.TEXTURE_2D, null);
}
...
((Da.prototype.close = Da.prototype.close),
  ...
  (Da.lerp = function (t, e, n, r, i) {
    return Ia(r * (1 - (t - e) / (n - e)) + i * (1 - (n - t) / (n - e)), r, i);
  }),
  (Da.clamp = Ia));
var Ka = class {
  constructor(t, e, n, r, i, s, o) {
    ((this.g = t),
      ...
      (this.j || this.m) &&
        0 === --Ya &&
        console.error("You seem to be creating MPImage instances without invoking .close(). This leaks resources."));
  }
  Ga() {
    return !!Ba(this, 0);
  }
...
const qa = (function (t) {
  ...
  ((Ja = class {
    ...
    addAudioToStreamWithShape(t, e, n, r, i) {
      const s = 4 * t.length;
      (this.h !== s && (this.g && this.i._free(this.g), (this.g = this.i._malloc(s)), (this.h = s)),
  ...
  if (t.U) {
    ...
    if (n?.rotationDegrees) {
      ...
      if ((Ln(s, 5, (-Math.PI * n.rotationDegrees) / 180), n?.rotationDegrees % 180 != 0)) {
        const [t, r] = zo(e);
        ((n = (An(s, 3) * r) / t), (i = (An(s, 4) * t) / r), Ln(s, 4, n), Ln(s, 3, i));
      }
    }
...
var ic = class extends sa {
  constructor(t, e, n, r) {
    (super(t), (this.g = t), (this.ba = e), (this.U = n), (this.ra = r), (this.P = new ga()));
  }
  l(t, e = !0) {
    if (
      ("runningMode" in t && Sn(this.baseOptions, 2, !!t.runningMode && "IMAGE" !== t.runningMode),
...
var sc = class extends ic {
  ...
  o(t) {
    return (
      "minDetectionConfidence" in t && Ln(this.h, 2, t.minDetectionConfidence ?? 0.5),
      "minSuppressionThreshold" in t && Ln(this.h, 3, t.minSuppressionThreshold ?? 0.3),
      this.l(t)
    );
  }
  D(t, e) {
...
var oc = $a(
  ...
  cc = $a([276, 283], [283, 282], [282, 295], [295, 285], [300, 293], [293, 334], [334, 296], [296, 336]),
  ...
  lc = $a([46, 53], [53, 52], [52, 65], [65, 55], [70, 63], [63, 105], [105, 66], [66, 107]),
...
var yc = class extends ic {
  ...
  o(t) {
    return (
      ...
      "minFaceDetectionConfidence" in t && Ln(this.s, 2, t.minFaceDetectionConfidence ?? 0.5),
      "minTrackingConfidence" in t && Ln(this.h, 4, t.minTrackingConfidence ?? 0.5),
      "minFacePresenceConfidence" in t && Ln(this.v, 2, t.minFacePresenceConfidence ?? 0.5),
  ...
  m() {
    ...
    (qi(n, "mediapipe.tasks.vision.face_landmarker.FaceLandmarkerGraph"),
      ...
      this.g.attachProtoVectorListener("face_landmarks", (t, e) => {
        for (const e of t) ((t = Es(e)), this.j.faceLandmarks.push(Co(t)));
        ea(this, e);
      }),
      ...
      this.outputFaceBlendshapes &&
        ...
        this.g.attachProtoVectorListener("blendshapes", (t, e) => {
          if (this.outputFaceBlendshapes)
            for (const e of t) ((t = fs(e)), this.j.faceBlendshapes.push(Po(t.g() ?? [])));
          ea(this, e);
        }),
...
var _c = class extends ic {
  constructor(t, e) {
    (super(new Za(t, e), "image_in", "norm_rect", !0), yn((t = this.j = new qs()), 0, 1, (e = new Ds())));
  }
  get baseOptions() {
  ...
  Pa(t, e, n) {
    ...
    if (((this.h = "function" == typeof e ? e : n), ec(this, t, r ?? {}), !this.h)) return this.s;
  }
  m() {
    var t = new os();
  ...
  for (const i of t) {
    ...
    for (const n of r.g())
      ((r = e && null != bn(n, 1) ? Tn(bn(n, 1), 0) : -1),
        t.push({ score: An(n, 2) ?? 0, index: r, categoryName: kn(n, 3) ?? "", displayName: kn(n, 4) ?? "" }));
    n.push(t);
  }
  return n;
}
var bc = class extends ic {
  ...
  o(t) {
    if (
      ...
      "minHandDetectionConfidence" in t && Ln(this.v, 2, t.minHandDetectionConfidence ?? 0.5),
      "minTrackingConfidence" in t && Ln(this.s, 4, t.minTrackingConfidence ?? 0.5),
      "minHandPresenceConfidence" in t && Ln(this.C, 2, t.minHandPresenceConfidence ?? 0.5),
      t.cannedGesturesClassifierOptions)
    ) {
      var e = new Zs(),
        n = e,
        r = Io(t.cannedGesturesClassifierOptions, pn(this.h, Zs, 3)?.h());
      (yn(n, 0, 2, r), yn(this.h, 0, 3, e));
    } else void 0 === t.cannedGesturesClassifierOptions && pn(this.h, Zs, 3)?.g();
    return (
      t.customGesturesClassifierOptions
        ? (yn((n = e = new Zs()), 0, 2, (r = Io(t.customGesturesClassifierOptions, pn(this.h, Zs, 4)?.h()))),
          yn(this.h, 0, 4, e))
        : void 0 === t.customGesturesClassifierOptions && pn(this.h, Zs, 4)?.g(),
      this.l(t)
    );
  }
  Ka(t, e) {
  ...
  m() {
    ...
    er(e, ho, this.j);
    const n = new Qi();
    (qi(n, "mediapipe.tasks.vision.gesture_recognizer.GestureRecognizerGraph"),
      Ji(n, "IMAGE:image_in"),
      Ji(n, "NORM_RECT:norm_rect"),
      ...
      this.g.attachProtoVectorListener("hand_landmarks", (t, e) => {
        for (const e of t) {
          ...
          for (const e of mn(t, vs, 1))
            n.push({ x: An(e, 1) ?? 0, y: An(e, 2) ?? 0, z: An(e, 3) ?? 0, visibility: An(e, 4) ?? 0 });
...
var kc = class extends ic {
  ...
  o(t) {
    return (
      ...
      "minHandDetectionConfidence" in t && Ln(this.j, 2, t.minHandDetectionConfidence ?? 0.5),
      "minTrackingConfidence" in t && Ln(this.h, 4, t.minTrackingConfidence ?? 0.5),
      "minHandPresenceConfidence" in t && Ln(this.s, 2, t.minHandPresenceConfidence ?? 0.5),
      this.l(t)
    );
  }
  D(t, e) {
    return ((this.landmarks = []), (this.worldLandmarks = []), (this.handedness = []), ec(this, t, e), Ac(this));
  }
  F(t, e, n) {
    return ((this.landmarks = []), (this.worldLandmarks = []), (this.handedness = []), nc(this, t, n, e), Ac(this));
  }
  m() {
    var t = new os();
    (is(t, "image_in"),
...
var Fc = class extends ic {
  ...
  o(t) {
    return (
      "minFaceDetectionConfidence" in t && Ln(this.s, 2, t.minFaceDetectionConfidence ?? 0.5),
      "minFaceSuppressionThreshold" in t && Ln(this.s, 3, t.minFaceSuppressionThreshold ?? 0.3),
      "minFacePresenceConfidence" in t && Ln(this.I, 2, t.minFacePresenceConfidence ?? 0.5),
      "outputFaceBlendshapes" in t && (this.outputFaceBlendshapes = !!t.outputFaceBlendshapes),
      "minPoseDetectionConfidence" in t && Ln(this.v, 2, t.minPoseDetectionConfidence ?? 0.5),
      "minPoseSuppressionThreshold" in t && Ln(this.v, 3, t.minPoseSuppressionThreshold ?? 0.3),
      "minPosePresenceConfidence" in t && Ln(this.L, 2, t.minPosePresenceConfidence ?? 0.5),
      "outputPoseSegmentationMasks" in t && (this.outputPoseSegmentationMasks = !!t.outputPoseSegmentationMasks),
      "minHandLandmarksConfidence" in t && Ln(this.K, 2, t.minHandLandmarksConfidence ?? 0.5),
      this.l(t)
    );
  }
  D(t, e, n) {
    const r = "function" != typeof e ? e : {};
    return ((this.C = "function" == typeof e ? e : n), xc(this), ec(this, t, r), Lc(this));
  }
  F(t, e, n, r) {
    const i = "function" != typeof n ? n : {};
    return ((this.C = "function" == typeof n ? n : r), xc(this), nc(this, t, i, e), Lc(this));
  }
  m() {
    var t = new os();
    ...
    (an(
      n,
      1,
      ne("type.googleapis.com/mediapipe.tasks.vision.holistic_landmarker.proto.HolisticLandmarkerGraphOptions"),
      "",
    ),
      (function (t, e) {
        if (null != e)
    ...
    const r = new Qi();
    (qi(r, "mediapipe.tasks.vision.holistic_landmarker.HolisticLandmarkerGraph"),
      wn(r, 8, Oi, n),
      ...
      this.outputPoseSegmentationMasks &&
        ...
        this.g.V("pose_segmentation_mask", (t, e) => {
          ((this.h.poseSegmentationMasks = [rc(this, t, !0, !this.C)]), ea(this, e));
        }),
      ...
      this.outputFaceBlendshapes &&
        ...
        this.g.attachProtoListener("extra_blendshapes", (t, e) => {
          ...
          (this.outputFaceBlendshapes && ((t = fs(t)), n.push(Po(t.g() ?? []))), ea(this, e));
        }),
  ...
  m() {
    ...
    (qi(n, "mediapipe.tasks.vision.image_classifier.ImageClassifierGraph"),
      ...
      this.g.attachProtoListener("classifications", (t, e) => {
        ((this.j = (function (t) {
          const e = {
            classifications: mn(t, As, 1).map((t) => Po(pn(t, us, 4)?.g() ?? [], Tn(bn(t, 2), 0), kn(t, 3))),
          };
...
var Ic = class extends ic {
  ...
  o(t) {
    ...
    return (
      (n = n ? n.clone() : new Ps()),
      void 0 !== t.l2Normalize ? Sn(n, 1, t.l2Normalize) : "l2Normalize" in t && $e(n, 1),
      void 0 !== t.quantize ? Sn(n, 2, t.quantize) : "quantize" in t && $e(n, 2),
      yn(e, 0, 2, n),
      this.l(t)
    );
  }
          ...
          (this.embeddings = (function (t) {
            return {
              embeddings: mn(t, Ls, 1).map((t) => {
                const e = { headIndex: Tn(bn(t, 3), 0) ?? -1, headName: kn(t, 4) ?? "" };
                if (void 0 !== dn(t, Ss, cn(t, 1)))
                  ((t = en((t = pn(t, Ss, cn(t, 1))), 1, Ht, tn())), (e.floatEmbedding = t.slice()));
                else {
                  const n = new Uint8Array(0);
                  e.quantizedEmbedding = pn(t, xs, cn(t, 2))?.qa()?.h() ?? n;
                }
                return e;
              }),
...
((Ic.cosineSimilarity = function (t, e) {
  if (t.floatEmbedding && e.floatEmbedding) t = Do(t.floatEmbedding, e.floatEmbedding);
  else {
...
var Nc = class extends ic {
  ...
  J() {
    !(function (t) {
      const e = mn(t.ea(), Qi, 1).filter((t) => kn(t, 1).includes("mediapipe.tasks.TensorsToSegmentationCalculator"));
      if (((t.s = []), e.length > 1))
  ...
  fa(t, e, n) {
    const r = "function" != typeof e ? e : {};
    return ((this.j = "function" == typeof e ? e : n), Oc(this), ec(this, t, r), Cc(this));
  }
  Na(t, e, n, r) {
    const i = "function" != typeof n ? n : {};
    return ((this.j = "function" == typeof n ? n : r), Oc(this), nc(this, t, i, e), Cc(this));
  }
  Fa() {
    return this.s;
  }
    ...
    (qi(n, "mediapipe.tasks.vision.image_segmenter.ImageSegmenterGraph"),
      ...
      this.outputConfidenceMasks &&
        ...
        this.g.da("confidence_masks", (t, e) => {
          ((this.confidenceMasks = t.map((t) => rc(this, t, !0, !this.j))), ea(this, e));
        }),
...
var $c = class extends ic {
  ...
  fa(t, e, n, r) {
    ...
    if (e.keypoint) {
      var a = new Xc();
      (Sn(a, 3, !0), Ln(a, 1, e.keypoint.x), Ln(a, 2, e.keypoint.y), _n(s, 5, Kc, a));
    } else {
      if (!e.scribble) throw Error("Must provide either a keypoint or a scribble.");
      for (a of ((o = new Wc()), e.scribble))
        (Sn((e = new Xc()), 3, !0), Ln(e, 1, a.x), Ln(e, 2, a.y), wn(o, 1, Xc, e));
      _n(s, 15, Kc, o);
    }
    (wn(r, 1, zc, s), this.g.addProtoToStream(r.g(), "drishti.RenderData", "roi_in", n), ec(this, t, i));
    t: {
      try {
        const t = new Uc(this.confidenceMasks, this.categoryMask, this.qualityScores);
        if (!this.j) {
          var c = t;
          break t;
        }
  ...
  m() {
    ...
    er(e, xo, this.h);
    const n = new Qi();
    (qi(n, "mediapipe.tasks.vision.interactive_segmenter.InteractiveSegmenterGraph"),
      Ji(n, "IMAGE:image_in"),
      Ji(n, "ROI:roi_in"),
      Ji(n, "NORM_RECT:norm_rect_in"),
      n.o(e),
  ...
  o(t) {
    return (
      void 0 !== t.displayNamesLocale
        ? $e(this.h, 2, ne(t.displayNamesLocale))
        : "displayNamesLocale" in t && $e(this.h, 2),
      void 0 !== t.maxResults ? xn(this.h, 3, t.maxResults) : "maxResults" in t && $e(this.h, 3),
      void 0 !== t.scoreThreshold ? Ln(this.h, 4, t.scoreThreshold) : "scoreThreshold" in t && $e(this.h, 4),
      void 0 !== t.categoryAllowlist ? Rn(this.h, 5, t.categoryAllowlist) : "categoryAllowlist" in t && $e(this.h, 5),
      void 0 !== t.categoryDenylist ? Rn(this.h, 6, t.categoryDenylist) : "categoryDenylist" in t && $e(this.h, 6),
      this.l(t)
    );
  }
  D(t, e) {
...
var th = class extends ic {
  ...
  o(t) {
    return (
      ...
      "minPoseDetectionConfidence" in t && Ln(this.j, 2, t.minPoseDetectionConfidence ?? 0.5),
      "minTrackingConfidence" in t && Ln(this.h, 4, t.minTrackingConfidence ?? 0.5),
      "minPosePresenceConfidence" in t && Ln(this.v, 2, t.minPosePresenceConfidence ?? 0.5),
  ...
  D(t, e, n) {
    const r = "function" != typeof e ? e : {};
    return ((this.s = "function" == typeof e ? e : n), Zc(this), ec(this, t, r), Qc(this));
  }
  F(t, e, n, r) {
    const i = "function" != typeof n ? n : {};
    return ((this.s = "function" == typeof n ? n : r), Zc(this), nc(this, t, i, e), Qc(this));
  }
  m() {
    var t = new os();
    (is(t, "image_in"),
    ...
    (qi(n, "mediapipe.tasks.vision.pose_landmarker.PoseLandmarkerGraph"),
      ...
      this.outputSegmentationMasks &&
        ...
        this.g.da("segmentation_masks", (t, e) => {
          ((this.segmentationMasks = t.map((t) => rc(this, t, !0, !this.s))), ea(this, e));
        }),
